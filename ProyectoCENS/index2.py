...
def main():
  ...
  #  df_2025PreguntasDirectivo.to_csv("df_2025PreguntasDirectivo.csv")
   ...
   # df_2025MiembrosImpresion = df_2025Miembros.copy()
    ...
    df_total2025 = df_2025Directivos #pd.concat([df_2025Directivos, df_2025Miembros], ignore_index=True)
   ...
   # graficar_por_categoria(df_promedioTotalCategoria)
    ...
    #df_promedio_dimension = ResultadoDimensionesDirectivo2025 #pd.concat([ResultadoDimensionesDirectivo2025, ResultadoDimensionesMiembro2025], ignore_index=True)
    #df_promedio_total_dimension = calcularPromedioTotalDimension(df_promedio_dimension,'Dimension','Valor')
    df_promedio_total = df_promedio_dimension_total_2025 #pd.concat([df_promedio_dimension_total_2023, df_promedio_dimension_total_2025], ignore_index=True)
    generar_grafica_radar_total(df_promedio_total,'Dimension','Valor')
    GenerarGraficaRadarDimensiones(df_promedio_total)


    df_promedio_componente = promedio_dimension_directivo #pd.concat([promedio_dimension_directivo, promedio_dimension_Miembro], ignore_index=True)
